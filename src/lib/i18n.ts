...
const dict = {
  zh: {
    ...
    manageSubscriptionsLoginRequired: "請先登入管理者才能修改追蹤項目",
    loginRequiredAddWebsite: "請先登入管理者才能新增網站",
    loginRequiredAddCategory: "請先登入管理者才能新增分類",
    adminNotConfiguredTitle: "尚未設定管理密碼",
    adminNotConfiguredMessage: "這個功能需要先設定環境變數 ADMIN_PASSWORD，請參考 README「管理者登入」章節設定後再試一次。",
  ...
  en: {
    ...
    manageSubscriptionsLoginRequired: "Sign in as administrator to manage subscriptions",
    loginRequiredAddWebsite: "Sign in as administrator to add a website",
    loginRequiredAddCategory: "Sign in as administrator to add a category",
    adminNotConfiguredTitle: "Admin password not set",
    adminNotConfiguredMessage: "This feature requires the ADMIN_PASSWORD environment variable to be set — see the README's “Admin Login” section, then try again.",
